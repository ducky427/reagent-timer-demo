(defproject reagent-timer-demo "0.1.0-SNAPSHOT"
  :description "Reagent react-timer-mixin demo"
  :url "http://ducky427.github.io/reagent-timer-demo"
  ...
  :profiles {:dev    {:cljsbuild {:builds {:app {:source-paths ["env/dev"]
                                                 :compiler {:main "reagent-timer-demo.dev"
                                                            :source-map true
                                                            :output-dir "resources/public/js/compiled/out"
                                                            :asset-path "js/compiled/out"
                                                            :source-map-timestamp true}
                                                 :figwheel {:on-jsload "reagent-timer-demo.core/mount-root"}}}}
